...
model_config_kwargs = dict(sequence_len=max_seq_len, vocab_size=vocab_size, n_layers=num_layers, n_heads=num_heads, hidden_dim=model_dim, n_kv_head=num_kv_heads)
